        ...
        store(
            {
                ...
                "paths": {
                    "ssh": ssh,
                    "remote py": python,
                    "local py": sys.executable,
                    "remote kernel file": remote_kernel_file,
                },
...
if __name__ == "__main__":
    ...
    optional.add_argument(
        "--session",
        action="store_true",
        help="store session information for this kernel",
    )
    optional.add_argument(
    ...
    required.add_argument(
        "--file", "-f", required=True, help="jupyter kernel connection file"
    )
